...
function Whoweare() {
  ...
  <div className="flex flex-col md:flex-row justify-between items-start bg-[#F9F3EF] rounded-xl w-full md:w-[1244px] h-auto md:h-[552px] shadow-sm p-6 md:p-8">
    ...
    <div className="flex justify-center items-center">
     <div className='bg-[#F0F5FF] w-[1224px] h-[696px] '>
...
<p className="text-center font-manrope text-[#212529] text-[12px] md:text-[13px] leading-relaxed px-9 mt-4">
  ...
  Ipsum has been Lorem Ipsum is simply dummy text of the printing and typesetting.
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mt-11 relative gap-12 md:gap-20">
        <div className="flex flex-row md:flex-col gap-6 mt-4 md:mt-10">
          <div className="absolute top-[10%] left-[15%] bg-white rounded-2xl shadow-md hover:shadow-md transition-all p-0 flex flex-col items-center text-center w-[196px] h-[128px] mx-auto md:ml-10">
           <img
        src="Figure (5).png"
        alt="Families"
        className="w-[194px] h-[95px] bg-[#FFC0C0] rounded-t-2xl object-cover"
      />
      <p className="text-[12px] font-semibold text-gray-900 mt-3 font-manrope text-center px-3">
        Trusted by 6000+ Families
      </p>
          </div>
          <div className="absolute top-[45%] left-[19%] bg-white rounded-2xl shadow-sm hover:shadow-md transition-all p-0 flex flex-col items-center text-center w-[183px] h-[116px] ">
        ...
        Professionally Trained For Home Cleaning
          ...
          <div className="absolute top-[50%] left-[3%] w-[144px] h-[154px] mx-auto md:ml-6">
            <img src="image (3).png" alt="Analytics" className="w-full h-full object-contain rounded-xl " />
          </div>
          <div className="absolute top-[20%] left-[3%] w-[144px] h-[144px] mx-auto md:ml-6">
            <img src="Container (8).png" alt="Reports" className="w-full h-full object-contain rounded-xl" />
          </div>
        </div>

        {/* Phone Mockup */}
        <div className="absolute left-[36%] top-[6.5%] w-[200px] h-[320px] md:w-[305px] md:h-[450px] z-10 mt-8 md:mt-0">
          <img
            src="iPhone 13 Pro (2).png"
            alt="Fixtek App"
            className="w-full w-[305px] h-[450px] object-contain"
          />
        </div>
        ...
        <div className="relative w-full md:w-[400px] h-[500px] mt-4 md:mt-10">
          {/* Top Card */}
          <div className="absolute top-[10%] left-[78%] bg-white rounded-2xl shadow-md hover:shadow-lg transition-all flex flex-col items-center text-center w-[172px] h-[107px]">
            <img
              src="Figure (4).png"
              alt="Quality"
          ...
          {/* Middle Card 1 */}
          <div className="absolute top-[50%] left-[75%] w-[144px] h-[154px]">
            <img
          ...
          {/* Middle Card 2 */}
          <div className="absolute top-[3%] left-[130%] w-[184px] h-[90px]">
            <img
              src="Vector (1).png"
              alt="Rewards"
              className="w-[144px] h-[144px] object-contain rounded-xl"
          ...
          {/* Bottom Card */}
          <div className="absolute bottom-[40%] left-[125%] bg-white rounded-2xl shadow-md hover:shadow-lg transition-all flex flex-col items-center text-center w-[200px] h-[122px]">
            <img
              src="Figure.png"
