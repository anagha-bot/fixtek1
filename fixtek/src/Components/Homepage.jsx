  ...
  return (
    <div className="min-h-screen bg-white font-manrope">
      ...
      <div className="w-full bg-white py-12 flex flex-col items-center text-center relative">
        ...
        {/* Main Heading */}
        <h1 className="text-[43px] md:text-[43px] font-extrabold mt-2 leading-snug relative text-manrope">
          <span className="relative font-extrabold text-manrope after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-full after:h-[6px] after:bg-black after:rounded">
            Home
          </span>{" "}
        ...
        <div className="flex gap-4 mt-4 relative">
          ...
          <span className="absolute -left-8  text-2xl">✦</span>
      ...
      <div className="relative w-full bg-white">
        ...
        <div className="absolute bottom-[0px] left-0 w-[1440px] h-[97px] bg-[#0c3b38] z-0"></div>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Card 1 */}
        <div className="bg-white rounded-xl shadow-md  p-0 flex flex-col items-center text-center  w-[362px] h-[226px]">
          <img
            src="Figure.png"
