  ...
  return (
    <div className="space-y-7">
      ...
      <div className="p-16 space-y-7">
        ...
        {/* Bottom Section */}
        <div className="bg-[#F3F7FF] shadow rounded-lg p-6 w-[1224px] h-[555px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 py-5 mt-3">
            {/* Card 1 */}
            <div className="bg-[#FFFFFF] shadow rounded-lg p-3 px-8 h-[440px] w-[601px]">
              <h3 className="text-[43px] font-regular mb-2 px-9">Why Join the Fixtek<br/> Network?</h3>
              <p className="text-[15px] text-[#4A5565] mb-2 py-2 px-9">
                Lorem Ipsum is simply dummy text of the printing and typesetting <br/>
                industry. Lorem Ipsum has been the industry’s standard dummy text <br/> 
                ever since the...
              </p>
              <button className="bg-[#023047] text-white px-5 py-3 rounded-md text-sm font-medium hover:bg-[#034c63] ">
                Partner With Us
              </button>
            </div>

            {/* Card 2 */}
            <div className="bg-[#F3F7FF] shadow rounded-lg p-3 px-8 w-[435px] h-[440px]">
              ...
              <button className="bg-[#F3F7FF] text-black px-5 py-2 shadow rounded-lg text-sm font-medium hover:bg-[#034c63]">
                Partner With Us
              </button>
            </div>
          </div>
