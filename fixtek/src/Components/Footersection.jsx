...
function Footersection() {
  return (
    <div className="bg-black text-white flex flex-col justify-between font-manrope mx-auto mt-12 rounded-3xl"
         style={{ width: "1360px", height: "930px" }}>
      ...
      <div className="flex flex-col items-center justify-center text-center py-16 md:py-20 px-4 relative rounded-2xl">
        ...
        <h1 className="text-[57px] text-3xl font-bold mb-3 leading-snug font-manrope">
          <span className="underline underline-offset-4 decoration-white">Home</span>{" "}
